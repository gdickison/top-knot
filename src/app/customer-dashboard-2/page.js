    ...
    <>
      <header className="absolute inset-x-0 top-0 z-50 flex h-16 border-b border-gray-900/10">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex md:gap-x-11 md:text-md md:font-semibold md:leading-6 md:text-gray-700">
        ...
        <div className="relative isolate overflow-hidden pt-16">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              <div className="order-last flex w-full gap-x-8 text-md font-semibold leading-6 sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:leading-7">
              ...
              <a
                href="#"
                className="ml-auto flex items-center gap-x-1 rounded-md bg-indigo-600 px-3 py-2 text-md font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
          ...
          <div className="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
            <dl className="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:px-2 xl:px-0">
              {stats.map((stat, statIdx) => (
                ...
                >
                  <dt className="text-md font-medium leading-6 text-gray-500">{stat.name}</dt>
                  <dd
                    className={classNames(
                    ...
                    <tbody>
                      {days.map((day) => (
                        <Fragment key={day.dateTime}>
                          <tr className="text-md leading-6 text-gray-900">
                          ...
                          {day.transactions.map((transaction) => (
                            <tr key={transaction.id}>
                              <td className="relative py-5 pr-6">
                                <div className="flex gap-x-6">
                                  ...
                                  <div className="flex-auto">
                                    ...
                                    {transaction.tax ? (
                                      <div className="mt-1 text-sm leading-5 text-gray-500">{transaction.tax} tax</div>
                                    ) : null}
                                  </div>
                                </div>
                              ...
                              <td className="hidden py-5 pr-6 sm:table-cell">
                                <div className="text-md leading-6 text-gray-900">{transaction.client}</div>
                                <div className="mt-1 text-sm leading-5 text-gray-500">{transaction.description}</div>
                              </td>
                              <td className="py-5 text-right">
                                <div className="flex justify-end">
                                  <a
                                    href={transaction.href}
                                    className="text-md font-medium leading-6 text-indigo-600 hover:text-indigo-500"
                                  >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-md font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                ...
                {clients.map((client) => (
                  <li key={client.id} className="overflow-hidden rounded-xl border border-gray-200">
                    <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6">
                      ...
                      />
                      <div className="text-md font-medium leading-6 text-gray-900">{client.name}</div>
